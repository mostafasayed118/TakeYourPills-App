...
TakeYourPills — Flutter medicine tracker (local-first, offline, privacy-focused).
...
lib/
├── core/
│   ├── entities/          # Domain models (Medication, DoseLog)
│   ├── error/             # Result type, AppError
│   └── utils/             # Shared utilities
├── data/
│   ├── database/          # Drift database, DAOs, mappers
│   └── repositories/      # Repository implementations
├── features/
│   ├── dashboard/         # Home dashboard feature
│   ├── medication/        # Medication CRUD feature
│   │   └── presentation/
│   │       ├── cubit/     # MedicationFormCubit, etc.
...
- Current key versions: Dart ^3.8.0, Drift ^2.34.1, BLoC ^9.2.1, GoRouter ^17.3.0
...
- Health data stays on-device unless explicitly shared
...
- Keep memory-bank/ current as a project map

## Public Repo Safety (YOU MUST FOLLOW)

This repository is public. Treat every file, command, commit, and push as visible to everyone.

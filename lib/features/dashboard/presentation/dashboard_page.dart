...
class DashboardPage extends StatelessWidget {
  ...
  Widget _buildAdherenceCard() => Container(
    ...
    child: Column(
      children: [
        Row(children: [
          _buildAdherenceRing(), const SizedBox(width: 24),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Container(padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6), decoration: BoxDecoration(color: AppColors.primaryContainer, borderRadius: BorderRadius.circular(6)),
              child: Text('4 of 5', style: AppTextStyles.titleSmall.copyWith(color: AppColors.onPrimaryContainer)),
            ), const SizedBox(height: 4), Text('Taken today', style: AppTextStyles.bodySmall.copyWith(color: AppColors.onSurfaceVariant)),
          ])),
        ]),
        const SizedBox(height: 16),
        Container(padding: const EdgeInsets.all(12), decoration: BoxDecoration(color: AppColors.errorContainer, borderRadius: BorderRadius.circular(8)),
          child: Row(children: [
            const Icon(Icons.warning, size: 20, color: AppColors.onErrorContainer), const SizedBox(width: 8),
            Text('1 Missed', style: AppTextStyles.bodySmall.copyWith(color: AppColors.onErrorContainer)), const Spacer(),
  ...
  Widget _buildAdherenceRing() => Stack(alignment: Alignment.center, children: [
  ...
  Widget _buildUpcomingList() => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Text('Upcoming Today', style: AppTextStyles.titleSmall),
    const SizedBox(height: 12),
    Container(padding: const EdgeInsets.all(1), decoration: BoxDecoration(color: Colors.transparent, borderRadius: BorderRadius.circular(16), boxShadow: const [BoxShadow(color: Color(0x0A000000), blurRadius: 20, offset: Offset(0, 4))]),
  ...
  Widget _buildUpcomingItem(String name, String dosage, String time, IconData icon) => InkWell(
    onTap: () {},
    child: Container(color: AppColors.surfaceContainerLowest, padding: const EdgeInsets.all(16),
      child: Row(children: [
